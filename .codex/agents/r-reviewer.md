...
2. **Read `.codex/rules/r-code-conventions.md`** for the current standards
...
- [ ] Check `.codex/rules/r-code-conventions.md` for known pitfalls
...
5. **Check Known Pitfalls.** See `.codex/rules/r-code-conventions.md` for project-specific bugs.
