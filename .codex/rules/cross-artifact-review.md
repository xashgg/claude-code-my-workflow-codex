...
- `.codex/skills/review-paper/SKILL.md` — the orchestrator.
- `.codex/skills/review-r/SKILL.md` — code reviewer.
- `.codex/skills/audit-reproducibility/SKILL.md` — numeric claims verifier.
- `.codex/rules/replication-protocol.md` — tolerance contract.
