...
- `.codex/skills/interview-me/SKILL.md` — produces the spec this skill consumes via `--input`.
- `.codex/skills/verify-claims/SKILL.md` — Phase 5 invokes this for citation post-flight.
- `.codex/references/discipline-cards.md` — field defaults that drive `--style` selection.
- `.codex/rules/replication-protocol.md` — preregistration is the *forward* commitment; replication-protocol is the *backward* contract.
